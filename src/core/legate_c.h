...
typedef enum legate_core_reduction_op_t {
  ADD = LEGION_REDOP_KIND_SUM,
  SUB = LEGION_REDOP_KIND_DIFF,
  MUL = LEGION_REDOP_KIND_PROD,
  DIV = LEGION_REDOP_KIND_DIV,
  MAX = LEGION_REDOP_KIND_MAX,
  MIN = LEGION_REDOP_KIND_MIN,
  OR  = LEGION_REDOP_KIND_OR,
  AND = LEGION_REDOP_KIND_AND,
  XOR = LEGION_REDOP_KIND_XOR,
