...
function(set_cpu_arch_flags out_)
  ...
  if(INTERNAL_BUILD_MARCH)
    ...
    if(COMPILER_SUPPORTS_MARCH)
      list(APPEND ${out_} "-march=${INTERNAL_BUILD_MARCH}" PARENT_SCOPE)
    elseif(BUILD_MARCH)
  ...
  if (NOT INTERNAL_BUILD_MARCH AND NOT DEFINED BUILD_MARCH)
    ...
    if(COMPILER_SUPPORTS_MCPU)
      list(APPEND ${out_} "-mcpu=${INTERNAL_BUILD_MCPU}" PARENT_SCOPE)
    elseif(BUILD_MCPU)
